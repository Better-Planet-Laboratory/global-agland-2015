...
def mark_GDD_filter(census, gdd_config, accept_ratio, marker, gdd_crop_criteria, *args):
    """
...
def main():
    ...
    print(
        'After nan filter: {}'.format(len(merged_census) - list(merged_census['CROPLAND']).count(MARKER['nan_filter'])))
