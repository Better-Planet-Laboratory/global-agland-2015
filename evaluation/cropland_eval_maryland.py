...
def main():
    ...
    parser.add_argument("--maryland_cropland_dir", type=str,
    ...
    parser.add_argument("--output_dir", type=str, default='./case_by_case_1_scale_itr3_fr_0/maryland/',
    ...
    maryland_cropland_reproj = np.empty((agland_map.height, agland_map.width), dtype=np.uint8)
    warp.reproject(
        maryland_cropland.read(1), maryland_cropland_reproj,
    ...
    plot_agland_map_slice(maryland_cropland_reproj / 100, 'cropland', args.output_dir + output_maryland_filename)

    # Figure 2. Difference between Maryland cropland and pred cropland
    plot_diff_maryland_pred_cropland(maryland_cropland_reproj, agland_map.get_cropland(),
                                     args.output_dir + output_diff_map_filename)

    # Figure 3. Histogram of difference map
    plot_histogram_diff_maryland_pred_cropland(maryland_cropland_reproj, agland_map.get_cropland(),
